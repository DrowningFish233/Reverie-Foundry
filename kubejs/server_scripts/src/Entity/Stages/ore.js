...
const ORES = [
    ...
    ["astages/ore/zenalite_stone_ore", "hazennstuff:zenalite_stone_ore", "first_kill_skeletron"],
    ["astages/ore/zenalite_abysslate_ore", "hazennstuff:zenalite_abysslate_ore", "first_kill_skeletron"],
...
const DEEPSLATE_ORES = [
    ...
    ["astages/ore/dreadstone_ore", "hazennstuff:dreadstone_ore", "first_kill_skeletron"],
    ["astages/ore/zenalite_deepslate", "hazennstuff:zenalite_deepslate_ore", "first_kill_skeletron"],
...
const NETHER_ORES = [
    ...
    ["astages/ore/solar_core_netherrack_ore", "hazennstuff:solar_core_netherrack_ore", "first_kill_skeletron"],
    ["astages/ore/solar_core_blackstone_ore", "hazennstuff:solar_core_blackstone_ore", "first_kill_skeletron"],
...
const END_ORES = [
    ...
    ["astages/ore/zenalite_end_stone_ore", "hazennstuff:zenalite_end_stone_ore", "first_kill_skeletron"],
