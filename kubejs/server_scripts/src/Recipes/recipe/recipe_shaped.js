ServerEvents.recipes(event => {
    ...
    event.shaped(
        Item.of('kubejs:calamatium_ingot', 1),
        [
            'DDD',
            'ACA',
            'ABA'
    ...
    event.shaped(
        Item.of('kubejs:dragon_upgrade_smithing_template', 1),
        [
            'CBC',
            'BAB',
            'CBC'
        ],
        {
            ...
            B: 'hazennstuff:runestone_fragments',
            C: '#iceandfire:scales/dragon'
        }
    )
    ...
    event.shaped(
        Item.of('kubejs:exploding_chocolate_bar', 1),
        [
            'BAB',
            'ACA',
            'BAB'
    ...
    */
    event.shaped(
        ...
        ],
        {
            ...
            B: 'kubejs:biomass_liquid'
        }
    )
    event.shaped(
        Item.of('kubejs:neptunium_ingot', 1),
        [
            'DCD',
            'DBD',
            'DAD'
