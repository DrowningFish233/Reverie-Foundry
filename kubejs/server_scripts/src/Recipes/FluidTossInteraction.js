...
EntityEvents.spawned('minecraft:item', event => {
    ...
    // 将非防火物品扔进熔岩会像平常一样消失
    if (event.entity.item.id == 'hazennstuff:permafrost_fragment')
        attemptSetBlock(30, event.entity, 'minecraft:water', 'minecraft:ice')

    if (event.entity.item.id == 'kubejs:estalt_ingot')
    ...
    if (event.entity.item.id == 'kubejs:raw_netherite_ingot')
        attemptConvertItem(30, event.entity, 'minecraft:lava', 'kubejs:estalt_ingot')
